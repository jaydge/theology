...
**Last updated: 260729-1** (created 260724-3). Read this file first, before any other project document.
...
|---|---|---|---|
| `PROJECT_STATE.md` | 260729-1 | Backstage | JD + Claude |
| `St_Francis_EMC_Distinctives.md` | 260729-1 | Backstage — findings corpus | JD only |
...
| `SRC_Manifest.md` | 260729-1 | Source registry | JD + Claude |
...
**Next free number by prefix:** `DQ-16` · `IP-13` · **`RV-24`** · **`LS-23`** · **`BLOG-45`** · **`VP-7`** · **`EXT-3`** · `QA` and `VP` are cross-reference label series, not finding series (see rule 5) · (GV, BP, RC, Rev closed batches)
