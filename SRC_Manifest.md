...
**Last updated: 260820-1** (date-stamped, format yymmdd-iteration)
...
| # | What | Sentences | Timestamp | Why queued |
|---|---|---|---|---|
| 26 | ⭐⭐⭐ **The tabernacle derived by consequence** | 2884-2890 | **3:16:47 - 3:17:26** | `IP-59` — **`DQ-9`'s positive datum.** Confirm the whole run is his and unbroken before anything is built on it |
...
| 31 | ⭐⭐⭐ **Communion admission and its preconditions** | 3487-3500 | **3:57:47 - 3:59:14** | `IP-64` — **Known Gap 11's communion half, moving for the first time in any era.** The highest-value item this pass adds |
...
| 33 | ⭐⭐⭐ **The rosary — and the ONE WORD the whole entry turns on** | 3233-3234, 3242, 3713 | **3:40:58 - 4:13:29** | `IP-66` — ⛔⛔ ***"good"* (B) vs *"true"* (A) at s3233, quoted in neither form; and *"which we obviously wouldn't do"* is SINGLE-RENDERING.** **The highest-value ear item this pass adds after 31** |
...
| 35 | ⭐ **The parish figures and the Anglican self-dating** | 3358-3364, 3749 | **3:49:40 - 4:16:04** | `IP-68` — **confirm *"13 years"* and its hedge; the renderings differ on the parish figure's self-correction** |
